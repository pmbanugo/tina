...
http_test_fixture_init :: proc(fixture: ^HTTP_Test_Fixture, router: Compiled_Router = {}) {
	...
	fixture.connection.connection_state.self_handle = tina.make_handle(0, HTTP_TYPE_OFFSET_CONNECTION, 0, 1)
...
http_test_fixture_request :: proc(
	...
	return _connection_make_request(&fixture.connection, frame)
}

@(private = "package")
http_test_fixture_response :: proc(fixture: ^HTTP_Test_Fixture) -> Response {
	return _connection_make_response(&fixture.connection)
}
